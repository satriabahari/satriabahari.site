    ...
    <>
      {items.map((item, index) => (
        <button
          ...
          className={`group relative h-[3.2em] w-[3.2em] bg-transparent outline-none [-webkit-tap-highlight-color:transparent] [perspective:24em] [transform-style:preserve-3d] ${
            item.customClass || ""
          }`}
        >
          <span
